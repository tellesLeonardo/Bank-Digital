defmodule BankDigitalApiWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: BankDigitalApiWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: BankDigitalApiWeb.Router,
        statics: BankDigitalApiWeb.static_paths()
    end
  end
